...
final class Pkcs12Builder implements Pkcs12BuilderInterface
{
    ...
    public function build(): string
    {
        ...
        $subject = $this->certificate->subject ?? $this->certificate->id;
        ...
        try {
            ...
            CaLog::log('pkcs12_build', 'info', "PKCS12 bundle built for: {$subject}", [
                'certificate_id' => $this->certificate->id,
                'friendly_name' => $this->friendlyName,
                'encryption_algorithm' => $this->encryptionAlgorithm,
                'chain_count' => count($chainDers),
                'legacy' => $this->legacy,
            ]);
